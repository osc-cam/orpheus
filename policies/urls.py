...
urlpatterns += [
    ...
    url(r'^api/deals/$', views.DealListAPIView.as_view(), name='api_deal'),
    url(r'^api/deals/(?P<pk>[0-9]+)/$', views.DealDetailAPIView.as_view(), name='api_deal_detail'),
    url(r'^api/epmc/$', views.EpmcListAPIView.as_view(), name='api_epmc'),
    url(r'^api/epmc/(?P<pk>[0-9]+)/$', views.EpmcDetailAPIView.as_view(), name='api_epmc_detail'),
